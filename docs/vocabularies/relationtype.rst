...
* ``IsObsoletedBy`` (indicates that A is obsoleted by B)
* ``Obsoletes`` (indicates that A obsoletes B)
* ``IsCollectedBy`` (indicates that A is collected by B)
* ``Collects`` (indicates that A collects B)
* ``IsTranslationOf`` (indicates that A is translation of B)
* ``HasTranslation`` (indicates that B is translation of A)
